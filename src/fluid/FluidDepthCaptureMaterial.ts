...
export class FluidDepthCaptureMaterial extends Material {
    constructor(ctx?: Context3D) {
        ...
        ShaderLib.register("FluidDepthCaptureShader", FluidDepthCaptureShader);

        const pass = new RenderShaderPass("FluidDepthCaptureShader", "FluidDepthCaptureShader");
        ...
        pass.setUniformColor("baseColor", new Color(1, 1, 1, 1));
